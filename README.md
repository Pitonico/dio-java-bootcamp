Disponibilizado por [cami-la](https://www.linkedin.com/in/cami-la/ "cami-la").<br>
...
<p><strong>PARADIGMAS PRINCIPAIS e SEUS SUBPARADIGMAS</strong></p>

🔸 <strong>1. Paradigma Imperativo</strong>
<p>Neste paradigma, o programa descreve o processamento necessário para solucionar o problema. Assim, o paradigma imperativo é caracterizado por execução sequencial de instruções, pelo uso de variáveis que representam posições de memória e pelo uso de instruções de atribuição que alteram os valores dessas variáveis.<br>
